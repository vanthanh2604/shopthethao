...
<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<img src="{{URL::to('/public/uploads/product/'.$value->hinhanh)}}" height="10%" width="80%" alt="" />
								<h3>ZOOM</h3>
							</div>
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<p><b>Thương hiệu:</b> {{$value->tenth}}</p>
										...
										<div class="product-image-wrapper">
											 <div class="single-products">
		                                        <div class="productinfo text-center">
		                                            <img src="{{URL::to('public/uploads/product/'.$lienquan->hinhanh)}}" alt="" />
		                                            <h2>{{number_format($lienquan->dongia).' '.'VNĐ'}}</h2>
		                                            <p>{{$lienquan->tensp}}</p>
